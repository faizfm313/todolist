...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    if (mysqli_num_rows($hasil) > 0) {
        ...
        if (password_verify($password, $baris['password'])) {
            ...
            $_SESSION['username'] = $baris['username']; // Still using username for session
                    ...
                    <div class="card-body">
                        <form method="POST">
                            <div class="gformlogin form-group">
                                ...
                                <input type="email" name="email" class="cformlogin form-control" placeholder="Enter email" required>
                            </div>
                            <div class="gformlogin form-group">
